    ...
    def match(cls, item):
        ...
        while not sell_group_data_frame.empty and not buy_group_data_frame.empty and sell_price <= buy_price:
            ...
            if buy_quantity == 0:
                ...
                index = cls.marketdataframe.index[cls.marketdataframe['ID'] == entry[0]].tolist()[0]
                cls.marketdataframe.drop(index = cls.marketdataframe.index[index], axis = 0, inplace = True)
